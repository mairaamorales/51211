...
export default class LenguajeVisitor extends antlr4.tree.ParseTreeVisitor {
	...
	// Visit a parse tree produced by LenguajeParser#excepcion.
	visitExcepcion(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by LenguajeParser#imprimir.
	visitImprimir(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by LenguajeParser#termino.
	visitTermino(ctx) {
	  return this.visitChildren(ctx);
	}
	...
	// Visit a parse tree produced by LenguajeParser#identificador.
	visitIdentificador(ctx) {
	  return this.visitChildren(ctx);
	}


	// Visit a parse tree produced by LenguajeParser#op.
	visitOp(ctx) {
	  return this.visitChildren(ctx);
	}
